...
private:
	...
	/** 종류별 기믹 스폰 횟수 추적용 */
	TMap<TSubclassOf<AActor>, int32> GimmickSpawnCountMap;
	...
	// 보물 상자 스폰
	//-------------------------
	/** 미로 생성 후 랜덤 스폰할 액터 후보 리스트 */
	UPROPERTY(EditAnywhere, Category = "Maze|Chest")
	TArray<TSubclassOf<AResourceNode>> TreasureBoxSpawnCandidates;
	...
	//-------------------------
	UPROPERTY()
	AResourceItemSpawnManager* ResourceItemSpawnManagerRef;
};